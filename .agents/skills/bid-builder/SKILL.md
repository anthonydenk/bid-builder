...
This repository-scoped entrypoint exposes the packaged skill to Codex while developing from this checkout.

Before doing any bid work, read and follow the canonical skill at `../../../skills/bid-builder/SKILL.md` in full, including every required reference it routes to.
